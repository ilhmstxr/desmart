                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="type" name="type" required
                                ...
                                <option value="irrigation" {{ old('type') == 'irrigation' ? 'selected' : '' }}>Irrigation
                                </option>
                                <option value="fertilizing" {{ old('type') == 'fertilizing' ? 'selected' : '' }}>Fertilizing
                                </option>
                                <option value="harvesting" {{ old('type') == 'harvesting' ? 'selected' : '' }}>Harvesting
                                </option>
                                <option value="maintenance" {{ old('type') == 'maintenance' ? 'selected' : '' }}>Maintenance
                                </option>
                        ...
                        <div>
                            <label for="scheduled_at" class="block text-sm font-medium text-gray-700 mb-1">Schedule Date &
                                Time</label>
                        ...
                        <div>
                            ...
                            <select id="priority" name="priority" required
                                ...
                                <option value="medium" {{ old('priority') == 'medium' ? 'selected' : '' }} selected>Medium
                                </option>
                        ...
                        <div>
                            <label for="field_id" class="block text-sm font-medium text-gray-700 mb-1">Field
                                (Optional)</label>
                        ...
                        <div>
                            <label for="crop_id" class="block text-sm font-medium text-gray-700 mb-1">Crop
                                (Optional)</label>
